...
export default function StaffPage() {
  const { staff, addStaff, updateStaff, deactivateStaff } = useStaff();
  ...
  /*
   * Only drivers are stored in Staff,
  ...
  /*
   * Convert vehicle ID into
   * a human-readable registration.
   */
   ...
   * Deactivate a driver.
   *
   * If the driver has a vehicle,
   * remove the driver from that
   * vehicle first.
   */
